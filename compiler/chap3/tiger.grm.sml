...
\\023\000\029\000\024\000\028\000\025\000\027\000\026\000\026\000\000\000\
\\162\000\000\000\
\\163\000\031\000\111\000\000\000\
\\164\000\000\000\
\\165\000\000\000\
\\166\000\000\000\
\\167\000\000\000\
...
\\180\000\000\000\
\\181\000\000\000\
\\182\000\044\000\070\000\000\000\
\\183\000\000\000\
...
\\113\000\083\000\096\000\040\000\
...
|  ( 48, ( ( _, ( MlyValue.ntVOID typedec1, _, typedec1right)) :: ( _,
 ( MlyValue.ntVOID typedecs1, typedecs1left, _)) :: rest671)) => let
 val  result = MlyValue.ntVOID (fn _ => ( let val  typedecs1 = 
typedecs1 ()
 val  typedec1 = typedec1 ()
 in ()
end; ()))
 in ( LrTable.NT 5, ( result, typedecs1left, typedec1right), rest671)
