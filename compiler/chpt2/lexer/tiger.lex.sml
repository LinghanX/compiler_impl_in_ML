...
fun yyAction12 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.LET(yypos, yypos + size "let")))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp <= #"/"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ37(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"l"
              ...
              then if inp = #"m"
                  then yyQ37(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  else yyQ69(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ37(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ104 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ86(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              else yyQ91(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  then yyQ53(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                  else yyQ37(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ37(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
              else yyAction3(strm, yyNO_MATCH)
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ84(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
              else yyAction3(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ17 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ86(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ85(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                  else yyAction3(strm, yyNO_MATCH)
              else yyAction3(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ15 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ87(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
              else yyAction3(strm, yyNO_MATCH)
      (* end case *))
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ88(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp < #"0"
              then yyAction3(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ88(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
...
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              then yyQ92(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
              else yyQ91(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
      (* end case *))
